...
\chapter{Wstęp teoretyczny}
    ...
    Matematycznie wzór (2.26) odpowiada sumie elementów diagonalnych tensora ciśnienia, gdy dominującą rolę
    odgdywają zdeżreznia (zmiana pędu). Zakładamy tu, że czynnik kinetycznych (prędkościowy) będzie w dużym stopniu
    redukował na silne kwazipenloolyczne odziaływanie z siąsiadami.
...
\chapter{Implementacja}
    ...
    \begin{enumerate}
        ...
        \item \emph{Węzeł na brzegu obiektu} - binarna flaga oznaczająca czy węzeł jest węzłem brzegowym.
...
\chapter{Testy}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=18cm]{performance_side_size}
        \caption{
