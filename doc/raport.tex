...
\chapter{Testy}
    ...
    Przeprowadzenie rozszerzonych testów dla mało wydajnych algorytmów wiązała zajęła by wiele godzin i
    nie dostarczyła by nowych informacji, dlatego nie zostały one wykonane. \\
    ...
    \end{figure}
    W tym przypadku możemy zaobserwować jeszcze większy skok wydajności.
