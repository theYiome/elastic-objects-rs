...
\chapter{Wstęp teoretyczny}
    ...
    możemy go opisać pod warunkiem że jesteśmy w stanie rozwiązać układ równań różniczkowych 
    drugiego rzędu jakie jakie otrzymujemy z równań ruchu dla całego układu złożonego z \emph{n} węzłów siatki.
    ...
    Do tego celu służy wiele metod jak np. metody Eulera, metody RK4, metody Verleta. \\
...
\chapter{Implementacja}
    ...
    Objawy niestabilności to między innymi destrukcja siatki lub nadanie węzłowi 
    ...
    Gdy takie wartości się pojawią obecny stan uznany jest za niepoprawny i symulacja wraca 
    ...
    zostanie wykonany powrót do poprzedniego stanu a krok czasowy zostanie zmniejszony o połowę. 
