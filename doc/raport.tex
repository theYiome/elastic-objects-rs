...
\chapter{Wprowadzenie}
    ...
    pozwalającym samodzielnie programować \emph{shadery} \cite{grafika3d} (strona 13), co 
    ...
    się z następujących kroków \cite{grafika3d} (strona 72):
    \begin{enumerate}
    ...
    (clip coordinate system) \cite{grafika3d} (strona 139). W aplikacji 
    ...
    danych z pozostałymi wątkami.' \cite{cleancode} (strona 198) \\
    ...
    polished set of tools to help you along the way'' - \cite{rustbook} (strona 1). Surowość kompilatora 
...
\chapter{Implementacja}
    ...
    Atrybut to ogólny, swobodny metadane, który jest interpretowany zgodnie z nazwą, konwencją, 
    językiem i wersją kompilatora. Atrybuty są wzorowane na Atrybutach w ECMA-335, ze składnią 
    pochodzącą z ECMA-334 (C\#).

    Atrybuty wewnętrzne, napisane z hukiem (\!) po hashu (\#), dotyczą elementu, w którym zadeklarowany 
    jest atrybut. Atrybuty zewnętrzne, napisane bez huku po hashu, odnoszą się do rzeczy następującej po atrybucie.

    Atrybut składa się ze ścieżki do atrybutu, po której następuje opcjonalne rozdzielane drzewo tokenów, 
    którego interpretacja jest zdefiniowana przez atrybut. Atrybuty inne niż atrybuty makr również pozwalają 
    na to, aby dane wejściowe były znakiem równości (\=), po którym następuje wyrażenie. Zobacz składnię 
    elementu meta poniżej, aby uzyskać więcej informacji.
...
\chapter{Testy}
    ...
    dużej ilości danych które muszą zostać skopiowane do pamięci karty graficznej, gdy 
    raportowane przez menażer zadań systemu Windows zużycie procesora graficznego podczas testu
    nie przekracza $30\%$ pomimo wy
...
\chapter{Podsumowanie}
    ...
    \begin{thebibliography}{9}
        ...
        \emph{Grafika 3D czasu rzeczywistego. Nowoczesny \emph{OpenGL}}, 
