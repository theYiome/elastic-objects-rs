...
\chapter{Wstęp teoretyczny}
    ...
    Znając siły działające na każdy element układu (węzły) możemy zapisać równania ruchu, 
    ...
    i to jest podstawowy cel dynamiki molekularnej. Wszystkie interesujące wielkości 
