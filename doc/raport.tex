...
\chapter{Implementacja}
    ...
    \subsection{Porównanie wydajności z siatką sąsiedztwa}
    Wykres prezenetujący wydajność dla najlepszej wersji wielodzeniwoej na CPU dla zwiększającej się liczby węzłów
    z włączoną siatką sąiedztwa oraz z wyłączoną siatką sąsiedztawa.
    ...
    Gdy korekta błędów jest włączona za każdym razem gdy zostanie wykryty bła i powrót do poprzedniego stanu
